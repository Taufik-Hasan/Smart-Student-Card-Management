                ...
                <?php 
                    ...
                    { ?>
                            <tr>
                                ...
                                <td align="center"><?php if($data['status']){echo "Due";}else echo "Paid"; ?></td>
                                <td align="center"><?php echo(rand(100,500)); ?></td>
                                <td align="center">
                                    <!--<button value="<?php echo $data['id']; ?>" type="submit" class="details_btn" onclick="openpopup()">details</button>-->
                                     <a href="#"> <button type="submit" class="details_btn">details</button></a> 
                                </td>
                              </tr> <?php
                            $i-- ;                                    
                    }
