        ...
        <table  id="styles"> 
            ...
            <tbody>
                <?php 
                    ...
                    $query =$DB->medical_service($student_id);
                    ...
                    { ?>
                            <tr>
                                ...
                                <td align="center">
                                    ...
                                    <a href="details.php?details_id=<?php echo $data['id']; ?> "> <button type="submit" class="details_btn" onclick="openpopup()">details</button></a> 
                                </td>
                              </tr> <?php
                            $i-- ;                                    
                    }
